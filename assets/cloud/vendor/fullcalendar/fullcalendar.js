...
/* A rectangular cloud that is absolutely positioned over other content
------------------------------------------------------------------------------------------------------------------------
Options:
  - className (string)
...
Bootstrap3Theme.prototype.classes = {
    ...
    popover: 'cloud cloud-default',
    popoverHeader: 'cloud-heading',
    popoverContent: 'cloud-body',
    // day grid
    // for left/right border color when border is inset from edges (all-day in agenda view)
    // avoid `cloud` class b/c don't want margins/radius. only border color.
    headerRow: 'cloud-default',
    dayRow: 'cloud-default',
    // list view
    listView: 'cloud cloud-default'
};
